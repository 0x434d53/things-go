...
type TMTask struct {
	...
	CachedTags                      []byte  `db:"cachedTags"`
	Start                           int     `db:"start"`
	StartDate                       int     `db:"startDate"`
	StartBucket                     int     `db:"startBucket"`
	ReminderTime                    int     `db:"reminderTime"`
	LastReminderInteractionDate     float64 `db:"lastReminderInteractionDate"`
	Deadline                        int     `db:"deadline"`
	DeadlineSuppressionDate         int     `db:"deadlineSuppressionDate"`
	T2DeadlineOffset                int     `db:"t2_deadlineOffset"`
	Index                           int     `db:"index"`
	TodayIndex                      int     `db:"todayIndex"`
	TodayIndexReferenceDate         int     `db:"todayIndexReferenceDate"`
	Area                            string  `db:"area"`
	...
	RT1InstanceCreationStartDate    int     `db:"rt1_instanceCreationStartDate"`
	RT1InstanceCreationPaused       int     `db:"rt1_instanceCreationPaused"`
	RT1InstanceCreationCount        int     `db:"rt1_instanceCreationCount"`
	RT1AfterCompletionReferenceDate int     `db:"rt1_afterCompletionReferenceDate"`
	RT1NextInstanceStartDate        int     `db:"rt1_nextInstanceStartDate"`
	Experimental                    []byte  `db:"experimental"`
	Repeater                        []byte  `db:"repeater"`
	RepeaterMigrationDate           float64 `db:"repeaterMigrationDate"`
}
